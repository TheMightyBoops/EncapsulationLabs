...
public class Employee {
    ...
    */
    ...
    private String meetDepartmentStaff() {
        metDeptStaff = true;
        return firstName + " " + lastName + " met with Dept. Staff on "
            + getFormattedDate();
    }
    ...
    public String reviewDeptPolicies() {
        ...
        return firstName + " " + lastName + " reviewed Dept policies on "
            + getFormattedDate();
    }
    ...
    public String moveIntoCubicle(String cubeId) {
        this.cubeId = cubeId;
        this.movedIn = true;
        return firstName + " " + lastName + " moved into cubicle "
